...
export default function AboutHero() {
  return (
    <section className="relative overflow-hidden border border-white/5 bg-[#060b16] min-h-screen lg:min-h-[650px] px-4 sm:px-6 lg:px-10 py-16 sm:py-20">
      ...
      <div className="absolute top-20 sm:top-35 left-[30%] sm:left-[45%] w-[220px] sm:w-[420px] h-[220px] sm:h-[420px] rounded-full bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.18),transparent_60%)] blur-[120px]"></div>

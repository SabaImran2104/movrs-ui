...
export default function AboutHero() {
  return (
    <section className="relative overflow-hidden border border-white/5 bg-[#060b16] min-h-162.5 px-10 py-20 ml-0 mt-0">
      ...
      <div className="absolute =top-55 -right-45 w-162.5 h-162.5 rounded-full bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.25),transparent_60%)]"></div>

      <div className="absolute -bottom-65 -left-50 w-175 h-175 rounded-full bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.20),transparent_60%)]"></div>

      <div className="absolute top-35 left-[45%] w-105 h-105 rounded-full bg-[radial-gradient(circle_at_center,rgba(168,85,247,0.18),transparent_60%)]"></div>
      ...
      <div className="relative z-10 max-w-190">
        ...
        <p className="mt-7 max-w-160 text-[20px] leading-9.5 text-[#94a3b8]">
          MOVRS transforms raw video into structured biomechanical datasets that enable machines to understand how humans move and interact in the real world — powering solutions in sports, workplace safety, and healthcare.
        </p>
